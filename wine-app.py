...
head_image = Image.open('/Users/jadegibson/Desktop/lhl_bootcamp/Wine/wine_head2.jpg')

@st.experimental_memo
def load_data():
       main_df = pd.read_csv('/Users/jadegibson/Desktop/lhl_bootcamp/Wine/table_10k')
       df_des = (pd.read_csv('/Users/jadegibson/Desktop/lhl_bootcamp/Wine/final_description_matrix_fp16').values).astype('float32')
       df_non_des = pd.read_csv('/Users/jadegibson/Desktop/lhl_bootcamp/Wine/non_description_mat').values
